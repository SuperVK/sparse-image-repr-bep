...
#figure(
  caption: [Comparing representations and higher-order components | 3000 Gaussians],
  grid(
    columns: (1fr, 1fr, 1fr),
    rows: (auto),
    gutter: 0pt,
